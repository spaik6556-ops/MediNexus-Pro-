      ...
      <aside className={`fixed top-0 left-0 h-full w-64 bg-white border-r border-stone-200 z-50 transform transition-transform lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-6">
          ...
          <nav className="space-y-1">
            ...
            {/* B2B Panel - available for all users */}
            <Link
              to={b2bNavItem.path}
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-stone-600 hover:bg-stone-100 transition-colors mt-4 pt-4 border-t border-stone-100"
              data-testid="nav-b2b"
            >
